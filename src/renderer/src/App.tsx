...
import { useFlowDispatchEvents } from './hooks/useFlowDispatchEvents'
...
const FlowsPage = lazy(() => import('./components/flows/FlowsPage'))
                        ...
                        <div className="flex flex-1 min-w-0 min-h-0 flex-col">
                          ...
                          <Suspense fallback={null}>
                            ...
                            >
                              ...
                              {activeView === 'flows' ? <FlowsPage /> : null}
